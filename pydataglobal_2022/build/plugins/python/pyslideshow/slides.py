...
from pyscript import Plugin, loop, Element, create

plugin = Plugin("py-slideshow")  # priority is optional, of course
...
@plugin.register_custom_element("py-slideshow")
class SlideShow(ExtensionTemplate):
    def __init__(self, element):
        self.element = element
        self.src_attr = element.getAttribute("src") or ""
        self.theme_attr = element.getAttribute("theme") or ""

        # self._children = []
        self._id = "slideshow" # TODO:!!!!self.parent.id
        self.slides_ = []
    ...
    def connect(self):
        ...
        loop.run_until_complete(self.get_slides())
    ...
    async def get_slides(self):
        ...
        console.log("Trying ti append stuff!!!")
        console.log(Element)
        self.main_div = create("div", self._id + "-gal", "CSSgal")
        console.log("Trying ti append stuff!!!")
        self.slides_wrap = create("div", self._id + "-wrap", "slider")
        self.slides_navi = create("div", self._id + "-navi", "prevNext")
        ...
        self.element.appendChild(self.main_div.element)

        # return self.main_div.element.innerHTML

        console.log("--------trying now-=--------")
        for class_ in [".language-html", ".language-python"]:
            for el in document.querySelectorAll(class_):
                console.log(f"{el.id}")
